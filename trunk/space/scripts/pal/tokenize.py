...
import token
# added ", "untokenize" "generate_tokens"" --mh
__all__ = [x for x in dir(token) if x[0] != '_'] + ["COMMENT", "tokenize", "untokenize", "generate_tokens", "NL"]
del token
...
def untokenize(iterable):
    ...
    for tok in iterable:
        ...
        if toknum == INDENT:
            ...
            startline = 1  # mh
        elif startline == 1 and indents: # mh
...
#  mh added abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ
#    namechars, numchars = string.ascii_letters + '_', '0123456789'
    namechars, numchars = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ' + '_', '0123456789'
    contstr, needcont = '', 0
    contline = None
    indents = [0]
